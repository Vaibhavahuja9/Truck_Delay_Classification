...
with open("D:\Machine Learning Projects\ML pipeline truck\Part 2 Code\Deployment\app_config.yaml","r") as file:
...
try:
    project1 = hopsworks.login(api_key_value=hopswork_key)
    fs = project1.get_feature_store()
